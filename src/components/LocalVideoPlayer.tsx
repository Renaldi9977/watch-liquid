...
import { Play, Pause, Volume2, VolumeX, Maximize, UploadCloud, FolderOpen } from 'lucide-react';
...
export const LocalVideoPlayer = forwardRef<any, LocalVideoPlayerProps>(
    ({ url, playing, controls, onPlay, onPause, onProgress }, ref) => {
        ...
        return (
            <div 
                ref={wrapperRef} 
                className={cn("custom-video-wrapper absolute inset-0 w-full h-full", (!playing || showControls) && "show-controls", !playing && "paused")}
            ...
            >
                ...
                {controls && (
                    <div className="video-overlay" onClick={togglePlay} style={{ opacity: playing ? 0 : '', pointerEvents: playing ? 'none' : 'auto' }}>
                ...
                {controls && (
                    <div className="custom-controls" onClick={(e) => e.stopPropagation()}>
                        ...
                        >
                            <div className="progress-buffered" style={{ width: `${bufferedPercent}%` }}></div>
                        ...
                        <div className="controls-row">
                            <div className="controls-left">
                                ...
                                <div className="volume-group ml-2">
                                    <button className="ctrl-btn p-1" onClick={() => setMuted(!muted)} title="Mute">
