        ...
        <div className="min-h-screen flex items-center justify-center p-4">
            ...
            >
                <div className="text-center">
                    <h2 className="text-xl font-bold tracking-tight text-white">WATCHPARTY<span className="text-cyan-400">.IO</span></h2>
                    <p className="text-[10px] uppercase tracking-widest text-slate-400 font-bold mt-2">Profile Setup</p>
                </div>
                ...
                <div className="flex flex-col items-center space-y-6">
                    ...
                    <div className="w-full space-y-4">
                        <div>
                            <label className="text-[10px] uppercase tracking-widest text-slate-400 font-bold mb-2 block">Display Name</label>
                            <input 
                                type="text"
                                value={name}
                        ...
                        <div>
                            <label className="text-[10px] uppercase tracking-widest text-slate-400 font-bold mb-3 block">Profile Glow</label>
